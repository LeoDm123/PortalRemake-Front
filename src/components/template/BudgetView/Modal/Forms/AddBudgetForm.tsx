...
import { createBudget, fetchCategorias } from '@/api/api'
...
export default function AddBudgetForm({ onClose }: AddModalProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            Swal.fire({
                title: 'Error',
                text: 'Hubo un problema al registrar el presupuesto.',
                icon: 'error',
                confirmButtonText: 'OK',
            })
            ...
            <div className="space-y-6">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        Ingrese los detalles de su presupuesto
                    </p>
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-x-3 gap-y-4 sm:grid-cols-6">
                        ...
                        <p className="sm:col-span-6 mt-2 mb-0 text-sm text-gray-600">
                            Seleccione si desea ahorrar un monto fijo o
                            porcentual de su ingreso
                        </p>
