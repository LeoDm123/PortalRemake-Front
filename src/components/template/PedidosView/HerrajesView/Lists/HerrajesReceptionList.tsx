...
type HerrajesReceptionListProps = {
    recepciones: Recepcion[]
}

const HerrajesReceptionList: React.FC<HerrajesReceptionListProps> = ({
    recepciones,
}) => {
    return (
            ...
            <TBody>
                {recepciones.map((recepcion, index) => (
                    <tr key={index}>
                        ...
                        <Td className="text-center">{recepcion.Unidad}</Td>
...
export default HerrajesReceptionList
